...
const HelpModal = ({
  ...
  <dialog id="MapHelp">
    ...
    {hasFullscreen ? (
      <p>
        For a larger map after the location is selected, click the full screen
        icon:
    ...
    <p>
      You can use the polygon tool on the right side of the map to outline the
      site area and estimate its acreage:
      <img className="icon" alt="polygon" src={polygonIcon} />
      <br />
      To create the boundary, click on each point that defines your field on the
      map.
      <br />
    ...
    {hasImport ? (
      <p>
        If you already have a shape file with your field boundaries, you can
        import it by clicking the&nbsp;
    ...
    <p>
      To delete and re-draw polygons, select the polygon, then click the trash
      can icon under the polygon tool:

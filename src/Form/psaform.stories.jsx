...
// Form with pre-populated labels
export const FormWithLabels = Template.bind({});
FormWithLabels.args = {
  apiUrl: 'https://developfeedback.covercrop-data.org/v1/issues',
  submitMessage: 'Feedback submitted successfully',
  headerTitle: 'Cover Crop Species Selector Feedback',
  ...
  fields: [
    ...
    },
    {
      ...
      label: 'Feedback Type',
      description:
        'Select the type of feedback you are providing. These selections are merged with the labels passed in via the `labels` prop.',
      options: [
        {
          label: 'About the Cover Crop Data',
          props: {
